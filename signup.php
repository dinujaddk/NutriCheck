...
<html>
    ...
    <body>
        <center><h1 id="Registrationform"><img src="IWT LOGO.jpg"  id="img1">Registration Form</h1>
            ...
            <form action="signupProcess.php" method = "post">
                    ...
                    <fieldset id="fieldset">
                        ...
                        <button type="submit" name="submit" id="bsub" onclick="validateForm()">Submit</button> 
